...
<body class="bg-gray-100 overflow-hidden">
    ...
    <div id="testUsersModal" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-hidden overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 h-full flex flex-col max-w-full">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="testUsersModal">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-hide="testUsersModal" type="button"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Acceptar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative w-full max-w-xl bg-white p-8 shadow-md">
            ...
            <form id="userForm" action="">
                ...
                <select id="userType" name="userType"
                    class="block w-full p-2 border border-gray-300 rounded-md mt-2 focus:outline-none focus:ring-2 focus:ring-blue-300">
                ...
                <input type="button" id="randomUserGeneratorButton"
                    class="block w-full mt-4 text-white bg-custom hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-custom dark:focus:ring-blue-800"
                    value="Generar usuari">
            </form>
            <br>
            ...
            <button id="uploadRandomGeneratedUser"
                class="block w-full mt-4 text-white bg-custom hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-custom dark:focus:ring-blue-800"
                type="button">Pujar dades</button>

            <button data-modal-target="testUsersModal" data-modal-toggle="testUsersModal" id="errorModalButton"
                class="block w-full mt-4 text-white bg-custom hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-custom dark:focus:ring-blue-800"
                type="button">
                Usuaris ja creats
            </button>
