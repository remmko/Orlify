...
<body class="bg-gray-100 overflow-hidden">
    ...
    <div class="flex items-center justify-center h-screen">
        <div class="relative w-full max-w-xl bg-white p-8 shadow-md">
            <div id="userDetailsSquare" class="flex flex-col items-center justify-center">
                ...
                <p id="userEmail" class="text-sm"></p>
    ...
    <script>
        ...
        function showUserDetails(userType) {
            ...
            // Set user details
            userName.innerHTML = "<strong>Nom:</strong> " + usuariRandom[userType].name.first + " " + usuariRandom[userType].name.last;
            userEmail.innerHTML = "<strong>Correu:</strong> " + usuariRandom[userType].email;
