                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <div>
                                            ...
                                            <div id="dropArea1"
                                                ...
                                                <span id="dropText1" class="">Seleccioneu una imatge o arrossegueu-la i
                                                    deixeu-la anar aquí</span>
                                                <input type="file" aria-label="Entrada de imatges" name="file" id="foto"
