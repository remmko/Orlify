            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg" id="user-dropdown">
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        ...
                        if (isset($_SESSION["auth"]) && $_SESSION["auth"] == "true") { ?>
                            <li>
                                <a href="/personaldata" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                    Dades personals
                                </a>
                            ...
                            if ($_SESSION["role"] == "admin") { ?>
                                <li>
                                    <a href="/adminpanel" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                        Panel de Administració
                                    </a>
                                </li>
                                <li>
                                    <a href="/rdmUser" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                        Usuaris de prova
                                    </a>
                                </li>
                            <?php } elseif ($_SESSION["role"] == "teacher") { ?>
                                <li>
                                    <a href="/teacherpanel" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                        Panel de Professor
                                    </a>
                                </li>
                                <li>
                                    <a href="/CSVpanel" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                        Pujada de CSV
                                    </a>
                                </li>
                            <?php } elseif ($_SESSION["role"] == "manager") { ?>
                                <li>
                                    <a href="/managerpanel" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                        ...
                        <?php } else { ?>
                            ...
                            <li>
                                <a href="/register" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                    Registrar-se
                                </a>
                            </li>
                        <?php } ?>
